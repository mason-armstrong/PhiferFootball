...
class newstoday_notice_review extends newstoday_notice {
	...
	public function review_notice() {
		...
		if ( ! get_option( 'newstoday_theme_installed_time' ) ) {
			update_option( 'newstoday_theme_installed_time', time() );
		}
	...
	public function review_notice_markup() {
		...
		$dismiss_url = wp_nonce_url(
			remove_query_arg( array( 'activated' ), add_query_arg( 'newstoday-hide-notice', 'review-user-' . $this->current_user_id ) ),
		...
		if ( ( get_option( 'newstoday_theme_installed_time' ) > strtotime( '-21 day' ) ) ) {
			return;
		}
				...
				--><div class="ilovewp-message-text">
					...
					<p>
						...
						printf(
							...
							'<a href="' . esc_url( admin_url( 'themes.php?page=newstoday-doc' ) ) . '"><strong>' . esc_html( $theme_data->Name ) . ' Theme</strong></a>',
							'<br>',
					...
					<p class="notice-buttons"><a href="https://wordpress.org/support/theme/newstoday/reviews/#new-post" class="btn button button-primary ilovewp-button" target="_blank"><span class="dashicons dashicons-awards"></span> <?php esc_html_e( 'Add a Rating for Newstoday', 'newstoday' ); ?></a>
					<a href="<?php echo esc_url( $dismiss_url ); ?>" class="btn button button-secondary"><?php esc_html_e( 'Hide this notice', 'newstoday' ); ?></a>
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=newstoday-doc' ) ); ?>" class="btn button button-secondary" target="_blank"><span><?php esc_html_e( 'Theme Help', 'newstoday' ); ?></span>
					</a></p>
