<?php 
		$ilovewp_logo = get_template_directory_uri() . '/ilovewp-admin/images/ilovewp-logo-white.png';
		...
		<div id="site-footer-credit">
			<div class="site-section-wrapper site-section-wrapper-footer-credit">
				<?php $copyright_default = __('Copyright &copy; ','newstoday') . date("Y",time()) . ' ' . get_bloginfo('name') . '. ' . __('All Rights Reserved. ', 'newstoday'); ?>
				<p class="site-credit"><?php echo esc_html(get_theme_mod( 'footer-text', $copyright_default )); ?> <span class="theme-credit"><?php esc_html_e('Theme by', 'newstoday'); ?> <a href="https://www.ilovewp.com/" rel="nofollow noopener" target="_blank" title="Free WordPress Themes"><img src="<?php echo esc_url($ilovewp_logo); ?>" width="51" height="11" class="footer-ilovewp-logo" alt="<?php esc_attr_e('Magazine WordPress Themes', 'newstoday');?>" /></a></span></p>
