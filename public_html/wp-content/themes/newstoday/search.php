...
<main id="site-main">
	...
	<div class="site-page-content">
		<div class="site-section-wrapper site-section-wrapper-main clearfix">
			...
			<h1 class="page-title"><?php esc_html_e('Search Results for', 'newstoday');?>: <strong><?php the_search_query(); ?></strong></h1>
			<?php get_search_form(); ?>
			...
			<hr /><div class="entry-content clearfix">
				...
				<p><?php esc_html_e( 'Apologies, but the search query did not return any results.', 'newstoday' ); ?></p>
