...
<footer id="colophon" class="site-footer" role="contentinfo">
	...
	<div class="site-info">
		<div class="container">
			...
			<?php echo esc_html_e(' | WordPress Theme Design by', 'elegantwriting') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'elegantwriting'); ?>"><?php echo esc_html_e('Superbthemes', 'elegantwriting') ?></a>
			</span>
