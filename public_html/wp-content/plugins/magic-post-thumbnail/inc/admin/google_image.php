...
<tr valign="top">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[googleimage][cxid]" value="<?php echo( isset( $options['googleimage']['cxid'] ) && !empty( $options['googleimage']['cxid'] ) )? trim( $options['googleimage']['cxid'] ): ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[googleimage][apikey]" value="<?php echo( isset( $options['googleimage']['apikey'] ) && !empty( $options['googleimage']['apikey']) )? trim( $options['googleimage']['apikey'] ): ''; ?>" >
	</td>
</tr>
