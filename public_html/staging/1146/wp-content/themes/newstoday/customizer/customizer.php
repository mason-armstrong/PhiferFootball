    ...
    class ILOVEWP_Customizer {
        ...
        private function get_panels() {
            return apply_filters( 'ilovewp_customizer_panels', array(
                'general'      => array( 'title' => esc_html__( 'General', 'newstoday' ) ),
                'footer'       => array( 'title' => esc_html__( 'Footer', 'newstoday' ) ),
            ) );
        }
...
// Extra styles
function newstoday_customizer_stylesheet() {
    
    // Stylesheet
    wp_enqueue_style( 'newstoday-customizer-css', get_template_directory_uri().'/ilovewp-admin/css/customizer-styles.css', NULL, NULL, 'all' );
    
}

add_action( 'customize_controls_print_styles', 'newstoday_customizer_stylesheet' );
...
function newstoday_customize_register( $wp_customize ) {
    ...
    // Custom help section
    class Newstoday_WP_Help_Customize_Control extends WP_Customize_Control {
        public $type = 'text_help';
        public function render_content() {
            $newstoday_ep_activated = '';
            if ( get_option( 'newstoday_ep_license_status' ) == 'valid' ) {
                $newstoday_ep_activated = 'bnt-customizer-ep-active';
            }
            echo '
                <div class="bnt-customizer-help">
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.ilovewp.com/documentation/newstoday/" target="_blank">
                        <span class="dashicons dashicons-book">
                        </span>
                        '.esc_html__( 'Theme Documentation', 'newstoday' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.ilovewp.com/themes/newstoday/" target="_blank">
                        <span class="dashicons dashicons-info">
                        </span>
                        '.esc_html__( 'Official Theme Page', 'newstoday' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://wordpress.org/support/theme/newstoday/" target="_blank">
                        <span class="dashicons dashicons-sos">
                        </span>
                        '.esc_html__( 'Support Forum', 'newstoday' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://wordpress.org/support/theme/newstoday/reviews/" target="_blank">
                        <span class="dashicons dashicons-heart">
                        </span>
                        '.esc_html__( 'Rate Newstoday', 'newstoday' ).'
                    </a>
                </div>
            ';
        }
        ...
        $wp_customize->add_section( 
            'newstoday_theme_support', 
            array(
                'title' => esc_html__( 'Theme Help & Support', 'newstoday' ),
                'priority' => 19,
            ) 
        );
        ...
        $wp_customize->add_control(
            new Newstoday_WP_Help_Customize_Control(
            $wp_customize,
            'newstoday_support', 
                array(
                    'section' => 'newstoday_theme_support',
                    'type' => 'text_help',
                )
            )
        );
