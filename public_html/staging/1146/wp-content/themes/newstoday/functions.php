...
if(is_admin()){	
	...
	if (current_user_can( 'manage_options' ) ) {
		...
		add_action('switch_theme', 'newstoday_db_data_remove');

		if ( ! function_exists( 'newstoday_db_data_remove' ) ) {
			function newstoday_db_data_remove() {

				delete_option( 'newstoday_admin_notices');
				delete_option( 'newstoday_theme_installed_time');
