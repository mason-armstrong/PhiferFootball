...
function gutenify_business_dark_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . gutenify_business_dark_get_color_value( $core_button_styles['color']['background'] ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		// var(--wp--preset--color--vivid-red)
		$element_css_styles .= '--wp--custom--core-button--color: ' . gutenify_business_dark_get_color_value( $core_button_styles['color']['text'] ) . ';';
	}
