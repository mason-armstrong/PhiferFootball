 ...
 * @since 2.0.0
 */
if( !class_exists( 'Article_Lite_Theme_Info' ) ) :
    class Article_Lite_Theme_Info {
        /**
         * Variable
         */ 
        ...
        function __construct() {
            $this->theme_name = esc_html( 'Article Lite' );
            $this->version = '2.0.0';
            ...
            <div id="theme-info-admin">
                <div class="info-container">
                    ...
                    <div class="info-block">
                        <a href="<?php echo esc_url('//blazethemes.com/documentation/article-lite/');?>" target="_blank" class="dashicons dashicons-book-alt info-icon"></a>
                        <p class="info-text">
                            <a href="<?php echo esc_url('//blazethemes.com/documentation/article-lite/');?>" target="_blank"><?php esc_html_e( 'Setup Tutorials', 'article-lite' ); ?></a>
                        </p>
                    </div>
                    <div class="info-block">
                        <a href="<?php echo esc_url( '//www.blazethemes.com/support' ); ?>" target="_blank" class="dashicons dashicons-sos info-icon"></a>
                        <p class="info-text">
                            <a href="<?php echo esc_url( '//www.blazethemes.com/support' ); ?>" target="_blank"><?php esc_html_e('Support','article-lite'); ?></a>
                        </p>
                    </div>
                    <div class="info-block">
                        <a href="<?php echo esc_url( '//blazethemes.com/theme/article-pro/' ); ?>" target="_blank" class="dashicons dashicons-embed-video info-icon"></a>
                        <p class="info-text">
                            <a href="<?php echo esc_url( '//blazethemes.com/theme/article-pro/' ); ?>" target="_blank">
                            <?php esc_html_e('Get Pro Version','article-lite'); ?></a>
                        </p>
                    </div>
                    <div class="info-block">
                        <a href="<?php echo esc_url( '//demo.blazethemes.com/article-lite' ); ?>" target="_blank" class="dashicons dashicons-desktop info-icon"></a>
                        <p class="info-text">
                            <a href="<?php echo esc_url( '//demo.blazethemes.com/article-lite' ); ?>" target="_blank"><?php esc_html_e('Theme demo','article-lite'); ?></a>
                        </p>
                    </div>
                </div><!-- .info-container -->
                <div class="theme-demos-listing">
                    <h2 class="info-title"><?php esc_html_e( 'Free and Premium Demos', 'article-lite' ); ?></h2>
                    <div class="demo-importer-actions">
                        <?php
                            ...
                            switch( $this->importer_status ) {
                                case 'inactive' : printf( esc_html__( 'Activate Blazethemes Demo Importer Now and Import any available demo in One Click', 'article-lite') . ' %s', '<button class="article-lite-importer-action-trigger" data-action="activate" data-process="' .esc_html( "Activating plugin" ). '">' .esc_html( 'Activate Plugin' ). '</button>' ); 
                                                break;
                                case 'install'  : printf( esc_html__( 'Install BlazeThemes Demo Importer and Import any available demo in One Click', 'article-lite') . ' %s', '<button class="article-lite-importer-action-trigger" data-action="install" data-process="' .esc_html( "Installing plugin" ). '">' .esc_html( 'Install and Activate Plugin' ). '</button>' );
                                                break;
        ...
        function theme_display_demos() {
                                ...
                                if (!empty($tags)) {
                                    ...
                                    <div class="blazethemes-demo-importer-tab-group" data-filter-group="tag">
                                        <div class="blazethemes-demo-importer-tab blazethemes-demo-importer-active" data-filter="*">
                                            <?php esc_html_e('All', 'article-lite'); ?>
                                        </div>
                                    </div>
                                    <?php
                                }
                                ...
                                <div class="blazethemes-demo-importer-demo-elements">
                                    <?php if ($type == 'pro') { ?>
                                        <div class="premium_label">
                                            <?php esc_html_e( 'Premium', 'article-lite' ); ?>
                                        </div>
                                    <?php } else{ ?>
                                        <div class="free_label"><?php esc_html_e( 'Free', 'article-lite' ); ?></div>
                                    <?php } ?>
                                    ...
                                    <div class="blazethemes-demo-importer-demo-actions">
                                        ...
                                        <div class="blazethemes-demo-importer-demo-buttons">
                                            <a href="<?php echo esc_url($demo_pack['preview_url']); ?>" target="_blank" class="button">
                                                <?php echo esc_html__('Preview', 'article-lite'); ?>
                                            </a> 
                                            ...
                                            if ($type == 'pro') {
                                                ...
                                                <a target="_blank" href="<?php echo esc_url($buy_url) ?>" class="button button-primary">
                                                    <?php echo esc_html__('Buy Now', 'article-lite') ?>
                                                </a>
                                            <?php } else {
                                                ...
                                                ?>
                                                            <a href="#blazethemes-demo-importer-modal-<?php echo esc_attr($demo_slug) ?>" class="blazethemes-demo-importer-modal-button button button-primary">
                                                                <?php echo esc_html__('Install', 'article-lite') ?>
                                                            </a>
                                            <?php 
                                                        }
                                                    }
            ...
            <?php } else {
                    ...
                    <div class="blazethemes-demo-importer-demo-wrap">
                        <?php esc_html_e("It looks like the config file for the demos is missing or conatins errors!. Demo install can't go futher!", 'article-lite'); ?>  
                    </div>
                <?php }
                ?>
                    ...
                    foreach ($this->demofile as $demo_slug => $demo_pack) {
                        ...
                        <div id="blazethemes-demo-importer-modal-<?php echo esc_attr($demo_slug) ?>" class="blazethemes-demo-importer-modal" style="display: none;">
                            ...
                            <div class="blazethemes-demo-importer-modal-header">
                                <h2><?php printf(esc_html('Import %s Demo', 'article-lite'), esc_html($demo_pack['name'])); ?></h2>
                            ...
                            <div class="blazethemes-demo-importer-modal-wrap">
                                <p><?php echo sprintf(esc_html__('We recommend you backup your website content before attempting to import the demo so that you can recover your website if something goes wrong. You can use %s plugin for it.', 'article-lite'), '<a href="https://wordpress.org/plugins/all-in-one-wp-migration/" target="_blank">' . esc_html__('All in one migration', 'article-lite') . '</a>'); ?></p>

                                <p><?php echo esc_html__('This process will install all the required plugins, import contents and setup customizer and theme options.', 'article-lite'); ?></p>

                                <div class="blazethemes-demo-importer-modal-recommended-plugins">
                                    <h4><?php esc_html_e('Required Plugins', 'article-lite'); ?></h4>
                                    <p><?php esc_html_e('For your website to look exactly like the demo,the import process will install and activate the following plugin if they are not installed or activated.', 'article-lite'); ?></p>
                                    <?php
                                    ...
                                    if (is_array( $plugins ) ) {
                                        ...
                                        ?>
                                        <ul>
                                            <li><?php esc_html_e('No Required Plugins Found.', 'article-lite'); ?></li>
                                        </ul>
                                        <?php
                                    }
                                    ?>
                                ...
                                <div class="blazethemes-demo-importer-reset-checkbox">
                                    <h4><?php esc_html_e('Reset Website', 'article-lite') ?></h4>
                                    <p><?php esc_html_e('Reseting the website will delete all your post, pages, custom post types, categories, taxonomies, images and all other customizer and theme option settings.', 'article-lite') ?></p>
                                    <p><?php esc_html_e('It is always recommended to reset the database for a complete demo import.', 'article-lite') ?></p>
                                    <label class="blazethemes-demo-importer-reset-website-checkbox">
                                        ...
                                        <?php echo esc_html('Reset Website - Check this box only if you are sure to reset the website.', 'article-lite'); ?>
                                    </label>
                                </div>

                                <a href="javascript:void(0)" data-demo-slug="<?php echo esc_attr($demo_slug) ?>" class="button button-primary blazethemes-demo-importer-import-demo"><?php esc_html_e('Import Demo', 'article-lite'); ?></a>
                                <a href="javascript:void(0)" class="button blazethemes-demo-importer-modal-cancel"><?php esc_html_e('Cancel', 'article-lite'); ?></a>
                            </div>
                        </div>
                        <?php
                    }
                ...
                <div id="blazethemes-demo-importer-import-progress" style="display: none">
                    <h2 class="blazethemes-demo-importer-import-progress-header"><?php echo esc_html__('Demo Import Progress', 'article-lite'); ?></h2>
        ...
        public function get_plugin_status($status) {
            switch ($status) {
                case 'install':
                    $plugin_status = esc_html__('Not Installed', 'article-lite');
                    break;

                case 'active':
                    $plugin_status = esc_html__('Installed and Active', 'article-lite');
                    break;

                case 'inactive':
                    $plugin_status = esc_html__('Installed but Not Active', 'article-lite');
                    break;
            }
         ...
         * 
         */
        function article_lite_importer_plugin_action() {
            check_ajax_referer( 'article-lite-theme-info-nonce', '_wpnonce' );
