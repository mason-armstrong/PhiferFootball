...
<tr valign="top">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[pixabay][username]" value="<?php echo( isset( $options['pixabay']['username'] ) && !empty( $options['pixabay']['username']) )? $options['pixabay']['username']: ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[pixabay][apikey]" value="<?php echo( isset( $options['pixabay']['apikey'] ) && !empty( $options['pixabay']['apikey']) )? $options['pixabay']['apikey']: ''; ?>" >
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[pixabay][imgtype]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[pixabay][search_country]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[pixabay][orientation]" >
			<?php
...
<tr valign="top">
	...
	<td>
		<input type="number" name="MPT_plugin_banks_settings[pixabay][min_width]" min="0" value="<?php echo( isset( $options['pixabay']['min_width'] ) && !empty( $options['pixabay']['min_width']) )? (int)$options['pixabay']['min_width']: '0'; ?>" > <i>px minimum for width</i>
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<input type="number" name="MPT_plugin_banks_settings[pixabay][min_height]" min="0" value="<?php echo( isset( $options['pixabay']['min_height'] ) && !empty( $options['pixabay']['min_height']) )? (int)$options['pixabay']['min_height']: '0'; ?>" > <i>px minimum for height</i>
	</td>
</tr>
...
<tr valign="top">
	...
	<td>
		<select name="MPT_plugin_banks_settings[pixabay][safesearch]" >
			<?php
